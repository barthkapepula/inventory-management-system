...
<<<<<<< HEAD:app/components/inventory/station-summary-modal.tsx
  const handleClose = () => {
    onClose()
...
=======
>>>>>>> 4a9719d20eb78a722b80fb90d1da0085717b8085:components/inventory/station-summary-modal.tsx
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg p-4 sm:p-6 w-full max-w-md">
        <h2 className="text-lg sm:text-xl font-bold mb-4">Export Summary by Station</h2>
        ...
        <div className="space-y-4">
          ...
          <div className="text-sm text-gray-600 bg-blue-50 p-3 rounded-md">
            <strong>Note:</strong> This report will show a summary of all stations for the selected date range and
            tobacco type, including total bales, weight, and value per station.
          </div>
        </div>
